...
const sumWithInitial = dataPoints.reduce(
  (accumulator, currentValue) => {

    currentValue = currentValue.replaceAll("one", "o1e")
    currentValue = currentValue.replaceAll("two", "t2o")
    currentValue = currentValue.replaceAll("three", "t3e")
    currentValue = currentValue.replaceAll("four", "f4r")
    currentValue = currentValue.replaceAll("five", "f5e")
    currentValue = currentValue.replaceAll("six", "s6x")
    currentValue = currentValue.replaceAll("seven", "s7n")
    currentValue = currentValue.replaceAll("eight", "e8t")
    currentValue = currentValue.replaceAll("nine", "n9e")

    let firstNumber = parseInt(currentValue.match(/\d+/)[0], 10);
    firstNumber = firstNumber.toString()[0]
    let lastNumber = parseInt(currentValue.split("").reverse().join("").match(/\d+/)[0], 10);
    lastNumber = lastNumber.toString()[0]
    currentValue = parseInt(firstNumber.concat(lastNumber));
